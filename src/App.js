...
const App = () => {
  return (
    <div className="main__container h-screen px-5 py-2 bg-[url('https://source.unsplash.com/random/1366x768/?nature,night')] bg-cover">
      <div className="upper_container h-[10%] flex justify-between items-center">
        <div className="left text-white">Hello There</div>
        <div className="right"><Weather/></div>
      </div>
      <div className="middle_container  h-[80%] flex flex-col justify-center items-center">
        <div className="time_conatiner"><Time/></div>
        <div className="greetings"><Greetings/></div>
        <div className="main_tasks text-white text-xl mt-3">What are the task for the day</div>
