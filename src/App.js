    ...
    return (
        <>
            ...
            {!user.name || !user.currLocation || !user.verified ? (
                ...
                <div id="main-container" className="main__container h-screen px-5 py-2] bg-opacity-75 bg-cover bg-black">
                    ...
                    <div className="middle_container  h-[80%] flex flex-col justify-center items-center">
                        ...
                        <div
                            className="todo_main_container bg-black py-1 pb-3 rounded-lg px-10 bg-opacity-60 mt-4 shadow-2xl">
