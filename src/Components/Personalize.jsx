  ...
  return (
    <div className="absolute bottom-10 bg-black h-[40vh] w-full bg-opacity-60 shadow-2xl rounded-lg p-4">
      <div className="location_settings">
        <p className="text-white text-2xl">Personalize Wallpapers🖼️</p>
        ...
        <div className="name_settings">
          ...
          <div className="choices flex mt-2">
            {themeChoice.map((elem, key) => {
              return (
                <div
                  className="flex border-[2px] mx-2 hover:bg-white hover:bg-opacity-30 cursor-pointer border-white rounded-full w-fit px-4 py-1 items-center"
                  key={key}
                >
          ...
          <button
            ...
            className="absolute bottom-3 font-light border-2 border-white rounded-full px-10 py-1 hover:bg-green-500 disabled:bg-red-600"
            onClick={() => {
